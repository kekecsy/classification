...
from MySampler import ProgressiveLabelSampler
...
def prepare_dataloader():
    ...
    train_sampler = ProgressiveLabelSampler(trainset, high_freq_label=high_freq, low_freq_label=low_freq, max_epochs=epoch, start_fraction=0.2)
    ...
    trainloader = MyDataLoader(trainset, batch_size=train_batch_size, collate_fn=collate_func, sampler=train_sampler)
